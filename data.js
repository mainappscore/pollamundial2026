...
const torneoData = {
  ...
  llaves: {
    clasificacion: {
      ...
      secondPlace: {
        A: "slot-16avos-P13-top", B: "slot-16avos-P13-bottom", C: "slot-16avos-P6-bottom",
        D: "slot-16avos-P14-top", E: "slot-16avos-P15-top", F: "slot-16avos-P3-bottom",
        G: "slot-16avos-P14-bottom", H: "slot-16avos-P10-bottom", I: "slot-16avos-P15-bottom",
        J: "slot-16avos-P8-bottom", K: "slot-16avos-P16-top", L: "slot-16avos-P16-bottom"
      },
      thirdPlaceSlots: [
        "slot-16avos-P1-bottom", "slot-16avos-P2-bottom", "slot-16avos-P4-bottom",
        "slot-16avos-P5-bottom", "slot-16avos-P7-bottom", "slot-16avos-P9-bottom",
        "slot-16avos-P11-bottom", "slot-16avos-P12-bottom"
      ]
    },
    ...
    rondas: [
      {
        ...
        partidos: [
          ...
          { id: "P5", top: "1E", bottom: "3A/B/C/D/F" },
          { id: "P6", top: "1F", bottom: "2C" },
          { id: "P7", top: "1G", bottom: "3A/E/H/I/J" },
      ...
      },
      {
        ...
        partidos: [
          { id: "P1", top: "Gan. 16-P5", bottom: "Gan. 16-P9" },
          { id: "P2", top: "Gan. 16-P13", bottom: "Gan. 16-P6" },
          { id: "P3", top: "Gan. 16-P16", bottom: "Gan. 16-P8" },
          { id: "P4", top: "Gan. 16-P4", bottom: "Gan. 16-P7" },
          { id: "P5", top: "Gan. 16-P3", bottom: "Gan. 16-P15" },
          { id: "P6", top: "Gan. 16-P1", bottom: "Gan. 16-P12" },
          { id: "P7", top: "Gan. 16-P10", bottom: "Gan. 16-P14" },
          { id: "P8", top: "Gan. 16-P2", bottom: "Gan. 16-P11" }
        ]
      },
      {
        id: "cuartos",
    ...
    progresion: [
      { ronda: "8avos", targetMatch: "P1", targetPos: "top", sourceRonda: "16avos", sourceMatch: "P5" },
      { ronda: "8avos", targetMatch: "P1", targetPos: "bottom", sourceRonda: "16avos", sourceMatch: "P9" },
      { ronda: "8avos", targetMatch: "P2", targetPos: "top", sourceRonda: "16avos", sourceMatch: "P13" },
      { ronda: "8avos", targetMatch: "P2", targetPos: "bottom", sourceRonda: "16avos", sourceMatch: "P6" },
      { ronda: "8avos", targetMatch: "P3", targetPos: "top", sourceRonda: "16avos", sourceMatch: "P16" },
      { ronda: "8avos", targetMatch: "P3", targetPos: "bottom", sourceRonda: "16avos", sourceMatch: "P8" },
      { ronda: "8avos", targetMatch: "P4", targetPos: "top", sourceRonda: "16avos", sourceMatch: "P4" },
      { ronda: "8avos", targetMatch: "P4", targetPos: "bottom", sourceRonda: "16avos", sourceMatch: "P7" },
      { ronda: "8avos", targetMatch: "P5", targetPos: "top", sourceRonda: "16avos", sourceMatch: "P3" },
      { ronda: "8avos", targetMatch: "P5", targetPos: "bottom", sourceRonda: "16avos", sourceMatch: "P15" },
      { ronda: "8avos", targetMatch: "P6", targetPos: "top", sourceRonda: "16avos", sourceMatch: "P1" },
      { ronda: "8avos", targetMatch: "P6", targetPos: "bottom", sourceRonda: "16avos", sourceMatch: "P12" },
      { ronda: "8avos", targetMatch: "P7", targetPos: "top", sourceRonda: "16avos", sourceMatch: "P10" },
      { ronda: "8avos", targetMatch: "P7", targetPos: "bottom", sourceRonda: "16avos", sourceMatch: "P14" },
      { ronda: "8avos", targetMatch: "P8", targetPos: "top", sourceRonda: "16avos", sourceMatch: "P2" },
      { ronda: "8avos", targetMatch: "P8", targetPos: "bottom", sourceRonda: "16avos", sourceMatch: "P11" },
